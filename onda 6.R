...
df <- read_csv("df.csv")
df <- df %>%
  filter(S002VS == 6)# onda 

dfao <- read_sav("dfao.sav")
dfao <- dfao %>%
  filter(S002VS == 6)# the same
...
df$partidos <- memisc::recode(as.factor(df$E179WVS), "Aprista" <- c(604002),
                               "Socialistas/Progressistas" <- c(604001,604005,604024),
                               "Democracia Cristã/Liberais"<-c(604006,604017,604036),
                               "Fujimoristas"<-c(604008,604026),
                               "Outros"<-c(604007,604021,604025,604027,
                                           604028,604029,604030,604031,604034,
                                           604035,604037,-2,-1,4))
...
hist(df$fundamentalism, breaks = 50, main = "2012 Liberal/Fundamentalismo")
hist(df$desconfiaInst, breaks = 50, main = "2012 Desconfiar de las instituciones")
hist(df$manoduro_adptado, breaks = 50, main = "2012 Mano Duro Adaptado")
hist(df$promercado, breaks = 50, main = "2012 Pro Mercado")
